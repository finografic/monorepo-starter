...
const data: Array<{ key: string; translations: Record<string, string> }> = [
  ...
  { key: 'ui.buttons.signIn', translations: { 'en-GB': 'Sign in', 'es-ES': 'Iniciar sesión' } },
  { key: 'ui.buttons.signOut', translations: { 'en-GB': 'Sign out', 'es-ES': 'Cerrar sesión' } },
  { key: 'ui.buttons.viewSource', translations: { 'en-GB': 'View on GitHub', 'es-ES': 'Ver en GitHub' } },
  ...
  { key: 'ui.nav.dashboard', translations: { 'en-GB': 'Dashboard', 'es-ES': 'Panel' } },
  { key: 'ui.nav.adminPanel', translations: { 'en-GB': 'Admin', 'es-ES': 'Administración' } },
